...
const Header = () => {
  ...
  return (
    <div className="flex items-center bg-amazon_blue py-3 text-white text-sm ">
      ...
      <div onClick={() => router.push('/orders')} className="px-5">
        <h1>Zwroty</h1>
      ...
      >
        <span className="absolute top-0 right-14 bg-yellow-400 h-5 w-5 text-center rounded-full text-black font-bold">
          {items.length}
        </span>
